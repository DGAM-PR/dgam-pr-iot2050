...
SRC_URI = "https://github.com/portainer/kubesolo/releases/download/v${PV}/kubesolo-v${PV}-linux-arm64-offline.tar.gz;sha256sum=1e4f41c0a1ac28f7a53a646e18757f9c74af79fea263a4b6c19cd1f65d2c4026 \
